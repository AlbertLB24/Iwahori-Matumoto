...
\begin{document}
    ...
    \iffalse\section{The Weyl Group}\label{chp:weylgroup}
    \input{weyl_group.tex}

    \fi\newpage
    \section{Chevalley Basis and Construction of Chevalley Groups}
    \input{chevalley_basis.tex}
